...
/**
 * DeliveryRequestOrigin Class Doc Comment
 *
 * @category Class
 * @package  Armada\SDK\Generated
 * @author   OpenAPI Generator team
 ...
 */
class DeliveryRequestOrigin implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'DeliveryRequest_origin';
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if (!preg_match("/^[a-f0-9]{24}$/", $this->container['branchId'])) {
            $invalidProperties[] = "invalid value for 'branchId', must be conform to the pattern /^[a-f0-9]{24}$/.";
        }
    ...
    public function setBranchId($branchId)
    {
        ...
        if ((!preg_match("/^[a-f0-9]{24}$/", ObjectSerializer::toString($branchId)))) {
            throw new \InvalidArgumentException("invalid value for \$branchId when calling DeliveryRequestOrigin., must conform to the pattern /^[a-f0-9]{24}$/.");
        }
